    ...
    <section id="details"
                ...
                <div class="grid sm:grid-cols-3 gap-5">
                    <div class="flex items-center gap-[10px] p-5 border border-[#F1F1F1] rounded-[20px] bg-white">
                        <div class="w-[38px] h-[38px] flex shrink-0">
                            <img src="{{asset('assets//icons/dollar-circle.svg')}}" class="w-full h-full object-contain"
                                alt="icon">
                        </div>
                        <div class="flex flex-col justify-center gap-[2px]">
                            <p class="text-sm text-[#545768]">Budget</p>
                            <p class="font-bold">Rp {{number_format($project->budget, 0,
                                ',', '.')}}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-[10px] p-5 border border-[#F1F1F1] rounded-[20px] bg-white">
        ...
        <div class="flex flex-col sm:w-[300px] h-fit shrink-0 bg-white rounded-[20px] p-5 gap-[30px]">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="" class="bg-[#030303] p-[14px_20px] rounded-full font-semibold text-white text-center">Bookmark
                    Job</a>
            </div>
            <div class="flex flex-col gap-3">
            ...
            <hr>
            <a href="" class="font-semibold border border-[#030303] p-[14px_20px] rounded-full text-center">Report this
                Job</a>
        </div>
    </section>
