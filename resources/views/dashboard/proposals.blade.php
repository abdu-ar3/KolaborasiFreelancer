            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-col md:flex-row gap-y-10 justify-between md:items-center">
                    ...
                    <div class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">Rp {{number_format($proposal->project->budget, 0,
                            ',', '.')}}</h3>
                    </div>

                    <div class="hidden md:flex flex-col">
                        <p class="text-slate-500 text-sm">Applied at</p>
                        <h3 class="text-indigo-950 text-xl font-bold">{{$proposal->created_at->format('D m Y')}}</h3>
                    </div>

                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{route('dashboard.proposals_details', [$proposal->project, $proposal->id])}}"
