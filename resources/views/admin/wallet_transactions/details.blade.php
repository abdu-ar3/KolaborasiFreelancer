        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">
                    {{$walletTransaction->type === 'Topup' ? 'Topup Details' : 'Withdrawals Details'}}
                </h3>
                <div class="flex flex-row gap-x-5 items-center justify-between">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{$walletTransaction->created_at->format('M d,
                            Y')}}
                        </h3>
                    </div>
                    <div class="">
                ...
                <div>
                    ...
                    <div class="flex flex-row gap-x-10">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{$walletTransaction->bank_account_number}}
                            </h3>
                        </div>
                        <div>
                            <p class="text-slate-500 text-sm">Account Name</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{$walletTransaction->bank_account_name}}</h3>
                        </div>
                    </div>
                ...
                <form method="POST" action="{{route('admin.wallet_transactions.update', $walletTransaction)}}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="proof" class="block mt-1 w-full" type="file" name="proof" required autofocus
                            autocomplete="proof" />
