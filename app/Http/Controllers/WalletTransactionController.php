...
class WalletTransactionController extends Controller
{
    ...
    {
        //
        $user_approved = User::where('id', $walletTransaction->user_id)->first();

        DB::transaction(function() use ($walletTransaction, $user_approved, $request){
            if($walletTransaction->type === 'Withdraw') {
                ...
                $user_approved->wallet->increment('balance', $walletTransaction->amount);
            }
        });
